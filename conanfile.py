...
class PxrVtConan(ConanFile):
    name = "pxr-vt"
    version = "26.8"
    package_type = "library"
    license = "LicenseRef-TOST-1.0"
    homepage = "https://github.com/untwine/pxr-vt"
    url = "https://github.com/untwine/pxr-vt"
    description = "Generic type value library used in OpenUSD"
    ...
    def configure(self):
        ...
        if self.options.python_version:
            ...
            self.options["pxr-gf"].python_version = self.options.python_version
    ...
    def package_info(self):
        ...
        self.cpp_info.builddirs = ["share/cmake/pxr-vt"]
        self.cpp_info.libs = ["PxrVt"]
