...
#ifndef PXR_VT_VALUE_H
#define PXR_VT_VALUE_H
...
VT_VALUE_SET_STORED_TYPE(pxr::boost::python::object, TfPyObjWrapper);
...
class VtValue
{
    ...
    struct _ProxyHelper
    {
        ...
        static TfPyObjWrapper GetPyObj(T const &obj) {
            ...
            TfPyLock lock;
            return pxr::boost::python::api::object(p);
#else
            return {};
#endif //PXR_PYTHON_SUPPORT_ENABLED
        }
                         ...
                         VtIsErasedValueProxy<ErasedProxy>::value>::type>
    {
        ...
        static TfPyObjWrapper GetPyObj(ErasedProxy const &obj) {
            ...
            TfPyLock lock;
            return pxr::boost::python::api::object(*val);
#else
            return {};
#endif //PXR_PYTHON_SUPPORT_ENABLED
        }
...
public:
    ...
    /// std::string. If T is pxr::boost::python::object, produce a VtValue holding
    /// a TfPyObjWrapper.
    template <class T>
...
ARCH_PRAGMA_POP
    ...
    // pxr::boost::python wrapped object corresponding to the held type.  This
